...
export const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoHref = `mailto:dask64576@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(bodyLines.join('\n'))}`;
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:dask64576@gmail.com" className="text-slate-400 hover:text-sky-500 transition-colors">
                    dask64576@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+919040757683" className="text-slate-400 hover:text-sky-500 transition-colors">
                    +91 90407 57683
                  </a>
                </div>
              </motion.div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-slate-900/80 border border-slate-700 rounded-lg text-slate-300 focus:outline-none focus:ring-2 focus:ring-sky-500 transition-all"
                    placeholder="dask64576@gmail.com"
                  />
                </div>
