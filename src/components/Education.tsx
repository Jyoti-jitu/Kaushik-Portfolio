...
const educations: Education[] = [
  {
    ...
    image: "https://th.bing.com/th/id/OIP.RzAi7bSZLg_bUxibA-6w3wHaEK?w=321&h=180&c=7&r=0&o=7&cb=12&dpr=1.3&pid=1.7&rm=3",
    degree: "Bachelor of Technology in Computer Science",
    year: "2023-2027",
    grade: "9.0/10"
  },
  {
    instituteName: "NIST Higher Secondary School",
    image: "/NIST.jpg",
      ...
      >
        <motion.div variants={itemVariants} className="text-center mb-16">
          ...
          <p className="text-slate-400 text-lg max-w-2xl mx-auto font-medium">
            My academic journey that has shaped my knowledge and expertise in computer science and web development.
          </p>
        </motion.div>
